...
import { Heart, Search, Volume2, X } from 'lucide-react';
...
export default function WordsPage() {
  ...
  const add = () => {
    if (!form.chinese.trim()) {
      setSaveError('Chinese word is required.');
      return;
    }
