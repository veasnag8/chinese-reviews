...
import { BookOpen, CalendarDays, ChartNoAxesColumnIncreasing, CircleUserRound, ClipboardList, GraduationCap, Heart, House, List, ListChecks, LogOut, PenLine, Repeat2, Settings, Sparkles, TextQuote } from 'lucide-react';
...
const navigation = [
  ...
  { href: '/review', label: 'Review', icon: Repeat2 }, { href: '/quizzes', label: 'Quiz', icon: ListChecks }, { href: '/quiz', label: 'Quiz Practice', icon: GraduationCap }, { href: '/writing', label: 'Practice Writing', icon: PenLine }, { href: '/favorites', label: 'Favorites', icon: Heart },
